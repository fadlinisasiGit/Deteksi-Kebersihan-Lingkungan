# -*- coding: utf-8 -*-
"""Pendeteksi_Kebersihan_Lingkungan3.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1rOGkTKfvxUH_Mk3a92yX7_XnmxiHQS_P
"""
...
class myCallback(tf.keras.callbacks.Callback):
  def on_epoch_end(self, epoch, logs={}):
    if(logs.get('accuracy')>0.9 and logs.get('val_accuracy')>0.9):
      print("\nTraining Model Stopped! Accuracy Model is above 90%!")
...
model.save_weights("model_deteksi.h5")
print("Model saved")